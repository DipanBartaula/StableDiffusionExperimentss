...
srun torchrun \
  ...
  train_DiT.py --curriculum none --max_steps 30000 --curvton_data_path ${DATA_DIR} --curvton_test_data_path ${TEST_DIR} --triplet_test_data_path ${TRIPLET_DIR} --batch_size 16 --num_workers 8 --gender all --save_interval 250 --image_log_interval 250 --skip_eval --run_name train_no_curriculum_hunyuan
