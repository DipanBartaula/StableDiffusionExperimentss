...
srun torchrun \
  ...
  train.py --dataset curvton --curriculum soft --stage_steps 4800 --max_steps 14400 --curvton_data_path ${DATA_DIR} --batch_size 16 --num_workers 8 --gender all --save_interval 1000 --image_log_interval 250 --skip_eval --run_name train_soft_curriculum_catvton_14400steps
