...
srun torchrun \
  ...
  train.py --dataset curvton --curriculum none --stage_steps 9600 --max_steps 28800 --phase2_data_path ${PHASE2_DIR} --phase2_start_step 28801 --curvton_data_path ${DATA_DIR} --batch_size 16 --num_workers 8 --gender all --save_interval 1000 --image_log_interval 250 --skip_eval --no_resume --run_name Stable_diffusion_train_no_curriculum_catvton_28800steps
