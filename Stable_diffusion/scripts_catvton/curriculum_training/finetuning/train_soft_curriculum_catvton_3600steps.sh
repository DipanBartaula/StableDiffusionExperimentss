...
srun torchrun \
  ...
  train.py --dataset curvton --curriculum soft --stage_steps 1200 --max_steps 3600 --curvton_data_path ${DATA_DIR} --batch_size 16 --num_workers 8 --gender all --save_interval 1000 --image_log_interval 250 --skip_eval --no_resume --run_name Stable_diffusion_train_soft_curriculum_catvton_3600steps
