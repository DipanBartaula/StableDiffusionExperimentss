...
srun torchrun \
  ...
  custom_model_pretraining/train.py --data_path ${DATA_DIR} --curriculum reverse --stage_steps 4800 --max_steps 14400 --batch_size 16 --num_workers 8 --save_interval 1000 --image_log_interval 1000 --no_resume --run_name Stable_diffusion_train_custom_dit_reverse_14400steps
