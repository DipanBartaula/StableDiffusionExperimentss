...
srun torchrun \
  ...
  train.py --dataset curvton --curriculum soft --stage_epochs 10 --max_steps 12000 --epochs 30 --data_fraction 0.10 --curvton_data_path ${DATA_DIR} --batch_size 16 --num_workers 8 --gender all --save_interval 1000 --image_log_interval 250 --skip_eval --no_resume --run_name Stable_diffusion_train_soft_curriculum_catvton_10pct
