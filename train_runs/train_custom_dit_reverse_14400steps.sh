#!/bin/bash
#SBATCH --job-name=cdit_rev_14400
#SBATCH --nodes=1
...
srun torchrun \
  ...
  custom_model_pretraining/train.py --model_size 250m --data_path ${DATA_DIR} --curriculum reverse --stage_steps 4800 --max_steps 30000 --batch_size 16 --num_workers 16 --save_interval 1000 --image_log_interval 1000 --no_resume --run_name Stable_diffusion_train_custom_dit_reverse_14400steps
