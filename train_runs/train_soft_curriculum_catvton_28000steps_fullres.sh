...
srun bash -c '
  torchrun \
    ...
    train.py --dataset curvton --curriculum soft --stage_steps 9600 --max_steps 28000 --curvton_data_path '"${DATA_DIR}"' --batch_size 4 --num_workers 16 --gender all --image_size 0 --save_interval 1000 --image_log_interval 500 --skip_eval --no_resume --run_name Stable_diffusion_train_soft_curriculum_catvton_28000steps_fullres
'
