...
srun torchrun \
  ...
  train.py --dataset curvton --difficulty easy --max_steps 30000 --curvton_data_path ${DATA_DIR} --batch_size 8 --num_workers 16 --gender all --save_interval 1000 --image_log_interval 500 --skip_eval --no_resume --run_name Stable_diffusion_train_hard_only_catvton
