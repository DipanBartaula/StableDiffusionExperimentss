...
srun torchrun \
  ...
  train.py --dataset curvton --curriculum soft --stage_steps 4000 --max_steps 30000 --epochs 30 --data_fraction 0.50 --curvton_data_path ${DATA_DIR} --batch_size ${BATCH_SIZE_PER_GPU} --num_workers 16 --gender all --save_interval 1000 --image_log_interval 1000 --skip_eval --no_resume --run_name Stable_diffusion_train_soft_curriculum_catvton_50pct
