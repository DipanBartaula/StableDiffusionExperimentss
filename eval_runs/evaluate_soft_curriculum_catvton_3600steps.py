...
RUN_NAME = 'train_soft_curriculum_catvton_3600steps'
CKPT_DIR = Path('/iopsstor/scratch/cscs/dbartaula/experiments_assets_1/train_soft_curriculum_catvton_3600steps/checkpoints')
