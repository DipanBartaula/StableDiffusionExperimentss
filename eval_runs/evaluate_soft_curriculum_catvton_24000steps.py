...
RUN_NAME = 'Stable_diffusion_train_soft_curriculum_catvton_24000steps'
CKPT_DIR = Path('/iopsstor/scratch/cscs/dbartaula/experiments_assets_1/Stable_diffusion_train_soft_curriculum_catvton_24000steps/checkpoints')
COMMAND = ['python', str(EVAL_SCRIPT), '--checkpoint', '__CKPT_PATH__', '--curvton_test_data_path', '/iopsstor/scratch/cscs/dbartaula/human_gen/dataset_v3_backup_1/dataset_ultimate_test', '--batch_size', '16', '--num_workers', '8', '--eval_frac_curvton', '0.25', '--curvton_splits', 'easy,medium,hard', '--triplet_test_data_path', '', '--street_tryon_data_path', '']
