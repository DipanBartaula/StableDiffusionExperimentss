...
RUN_NAME = 'train_soft_curriculum_catvton_28800steps'
CKPT_DIR = Path('/iopsstor/scratch/cscs/dbartaula/experiments_assets_1/train_soft_curriculum_catvton_28800steps/checkpoints')
