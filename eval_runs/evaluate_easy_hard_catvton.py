...
RUN_NAME = 'train_easy_hard_soft_curriculum_catvton'
CKPT_DIR = Path('/iopsstor/scratch/cscs/dbartaula/experiments_assets_1/train_easy_hard_soft_curriculum_catvton/checkpoints')
