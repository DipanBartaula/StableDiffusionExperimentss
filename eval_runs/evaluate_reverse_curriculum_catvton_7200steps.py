...
RUN_NAME = 'train_reverse_curriculum_catvton_7200steps'
CKPT_DIR = Path('/iopsstor/scratch/cscs/dbartaula/experiments_assets_1/train_reverse_curriculum_catvton_7200steps/checkpoints')
