...
CKPT_DIR = Path("/iopsstor/scratch/cscs/dbartaula/experiments_assets_1/train_stable_vton/checkpoints")
COMMAND = [
    "python",
    "cross-architecture/StableVTON/evaluate.py",
    "--checkpoint",
    "__CKPT_PATH__",
    ...
    "--num_workers",
    "8",
    "--eval_frac_curvton", "0.005",
    "--eval_frac_triplet", "0.005",
    "--eval_frac_street", "0.005",
    "--output_json",
    "/iopsstor/scratch/cscs/dbartaula/experiments_assets_1/train_stable_vton/eval_metrics.json",
]
