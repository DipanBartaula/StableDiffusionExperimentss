...
RUN_NAME = 'train_custom_dit_reverse_7200steps'
CKPT_DIR = Path('/iopsstor/scratch/cscs/dbartaula/custom_dit_assets/train_custom_dit_reverse_7200steps/checkpoints')
