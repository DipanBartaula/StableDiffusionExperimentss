...
RUN_NAME = 'train_soft_curriculum_catvton_14400steps'
CKPT_DIR = Path('/iopsstor/scratch/cscs/dbartaula/experiments_assets_1/train_soft_curriculum_catvton_14400steps/checkpoints')
