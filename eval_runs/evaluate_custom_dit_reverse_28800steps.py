...
RUN_NAME = 'train_custom_dit_reverse_28800steps'
CKPT_DIR = Path('/iopsstor/scratch/cscs/dbartaula/custom_dit_assets/train_custom_dit_reverse_28800steps/checkpoints')
