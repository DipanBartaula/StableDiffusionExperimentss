...
RUN_NAME = 'train_no_curriculum_catvton_14400steps'
CKPT_DIR = Path('/iopsstor/scratch/cscs/dbartaula/experiments_assets_1/train_no_curriculum_catvton_14400steps/checkpoints')
