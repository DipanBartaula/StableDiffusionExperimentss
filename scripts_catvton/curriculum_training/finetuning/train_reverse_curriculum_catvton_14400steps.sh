...
srun torchrun \
  ...
  train.py --dataset curvton --curriculum reverse --stage_steps 4800 --max_steps 14400 --curvton_data_path ${DATA_DIR} --batch_size 16 --num_workers 8 --gender all --save_interval 1000 --image_log_interval 1000 --skip_eval --no_resume --run_name Stable_diffusion_train_reverse_curriculum_catvton_14400steps
