...
srun torchrun \
  ...
  custom_model_pretraining/train.py --model_size 250m --data_path ${DATA_DIR} --curriculum none --stage_steps 9600 --max_steps 28800 --phase2_data_path ${PHASE2_DIR} --phase2_start_step 28801 --batch_size 16 --num_workers 8 --save_interval 1000 --image_log_interval 1000 --no_resume --run_name Stable_diffusion_train_custom_dit_none_28800steps
