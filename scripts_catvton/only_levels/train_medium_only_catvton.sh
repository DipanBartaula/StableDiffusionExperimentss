...
srun torchrun \
  ...
  train.py --dataset curvton --difficulty medium --max_steps 30000 --curvton_data_path ${DATA_DIR} --batch_size 16 --num_workers 8 --gender all --save_interval 1000 --image_log_interval 1000 --skip_eval --no_resume --run_name Stable_diffusion_train_medium_only_catvton
